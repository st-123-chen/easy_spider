...
def run():
    url = 'https://m.weibo.cn/comments/hotflow?id=4499162437718729&mid=4499162437718729&max_id_type=0'   # TheShy最新微博评论内容的初始url地址
    html = get_data(url)
    ...
    while max_id:
        url = 'https://m.weibo.cn/comments/hotflow?id=4499162437718729&mid=4499162437718729&max_id='+str(max_id)
        html = get_data(url)
        max_id = json.loads(html)['data']['max_id']
        contents = parse_data(html)
        save_data(contents)
